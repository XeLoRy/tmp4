...
ordre: 4
engagements:
  - Assainir et maîtriser les finances de la commune
...
* Etudier la faisabilité d'une zone artisanale pour favoriser l'installation des jeunes artisans de la commune et soutenir le commerce de proximité
...
**Préserver et valoriser l'économie locale.** \
**Être acteurs d'un développement raisonné.**
